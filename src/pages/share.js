...
const DonorPage = () => {
  ...
  const onSubmit = async (data) => {
    ...
    const scriptUrl =
      "https://script.google.com/macros/s/AKfycbzDW0Tqf39q7Waxu_ffz-ZrqomsoqfRhKGLbkoEMvgsjey_9gDN76-5/exec";
    try {
      ...
      setMessage(
        "Terimakasih, kami akan segera menghubungi Kamu jika terdapat pasien yang cocok."
      );
    } catch (error) {
  ...
  return (
    <Layout>
      ...
      <Section accent="secondary">
        ...
        >
          <h1 style={{ marginBottom: "3rem" }}>Donor Plasma</h1>
          <form
